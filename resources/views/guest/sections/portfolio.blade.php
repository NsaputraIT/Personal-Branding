            ...
            <div class="col-lg-6 col-md-6 portfolio-item isotope-item filter-{{ \Illuminate\Support\Str::slug($item->category) }}">
              <div class="portfolio-card">
                <div class="portfolio-image">
                  <img src="{{ $item->image_path && !str_starts_with($item->image_path, 'asset/') ? $cdnUrl . '/' . ltrim($item->image_path, '/') : asset('asset/img/portfolio/portfolio-1.webp') }}" class="img-fluid" alt="" loading="lazy">
                  <div class="portfolio-overlay">
                    <div class="portfolio-actions">
                      <a href="{{ $item->image_path && !str_starts_with($item->image_path, 'asset/') ? $cdnUrl . '/' . ltrim($item->image_path, '/') : asset('asset/img/portfolio/portfolio-1.webp') }}" class="glightbox preview-link" data-gallery="portfolio-gallery-{{ \Illuminate\Support\Str::slug($item->category) }}"><i class="bi bi-eye"></i></a>
